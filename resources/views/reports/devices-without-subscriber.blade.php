    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
            <div>
                <div class="flex items-center gap-2">
                    ...
                    <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Devices Without Subscriber</h1>
                </div>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">{{ $devices->total() }} orphaned devices need subscriber linking</p>
            </div>
        </div>
        ...
        <div class="bg-purple-50 dark:bg-purple-900/30 border border-purple-200 dark:border-purple-800 rounded-lg p-4 mb-6">
            <div class="flex">
                ...
                <div>
                    <h3 class="text-sm font-medium text-purple-800 dark:text-purple-200">Subscriber Linking Required</h3>
                    <p class="text-sm text-purple-700 dark:text-purple-300 mt-1">
                        These devices are not linked to any subscriber record.
                        They could be: lab/test equipment, spare inventory, newly provisioned devices awaiting customer assignment,
                        or devices that need manual subscriber matching.
                    </p>
                </div>
            </div>
        </div>
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr>
                        <td colspan="6" class="px-4 py-8 text-center text-gray-500 dark:text-gray-400">
                            ...
                            <p class="text-lg font-medium">All devices are linked!</p>
                            <p class="text-sm">Every device has an associated subscriber.</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
