...
<div class="space-y-6">
    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        <form action="{{ route('device-types.update', $deviceType) }}" method="POST">
            @csrf
            @method('PATCH')
            ...
            <div class="px-4 py-5 sm:p-6 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $deviceType->name) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="manufacturer" id="manufacturer" value="{{ old('manufacturer', $deviceType->manufacturer) }}"
                ...
                <div>
                    ...
                    <input type="text" name="product_class" id="product_class" value="{{ old('product_class', $deviceType->product_class) }}"
                ...
                <div>
                    ...
                    <input type="text" name="oui" id="oui" value="{{ old('oui', $deviceType->oui) }}"
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3"
                              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm @error('description') border-red-500 @enderror">{{ old('description', $deviceType->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
